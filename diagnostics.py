...
def dataframe_summary():
    ...
    return (list(summary_stats)) #return value should be a list containing all summary statistics
...
def execution_time():
    ...
    return [end_time_training, end_time_ingestion] #return a list of 2 timing values in seconds
